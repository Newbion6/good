...
-----------------------------------------------------------------------
	...
	--------CODING CREW--------
	--CODER 1
	makeLuaText('CODER1', 'Events added by Súriv', 1000, 132, -1000)
	...
	--CODER 2
	makeLuaText('CODER2', 'Script by RamenDominoes', 1000, 132, -1000)
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'Sprite by Romgk', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'BG by ???', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'Hollow by KawaiiPro8', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'OG Chart by InsertName011', 1000, 132, -1000)
	...
	--CHARTER 2
	makeLuaText('CHARTER2', 'New Chart by Súriv', 1000, 132, -1000)
